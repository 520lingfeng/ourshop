...
<!-- 右侧内容框架，更改从这里开始 -->
    ...
    <xblock>
        ...
        <a href="/admin/articel/create" class="layui-btn"><i class="layui-icon">&#xe608;</i>添加</a>
    ...
    <table class="layui-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="td-manage">
                    <a title="编辑" href="/admin/articel/{{ $v->id }}/edit"
                    class="ml-5 btn btn-warning" style="text-decoration:none">
                        编辑
                    </a>
                    
                    <form action="/admin/articel/{{ $v->id }}" method="post" style="display:inline">
                        {{-- 令牌post方法必加 --}}
                        {{ csrf_field() }}
    ...
    <!-- 分页 --> 
    <div class="text-center">{{ $articel->links() }}</div>
