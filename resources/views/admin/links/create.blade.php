...
<!-- 右侧内容框架，更改从这里开始 -->
	<form class="layui-form" action="/admin/links" method="post" enctype="multipart/form-data">
	    <div class="layui-form-item">
	        <label for="L_pass" class="layui-form-label wd">
	            <span class="x-red">*</span>链接名称
	        </label>
	        <div class="layui-input-inline">
	            <input type="text" id="L_pass" name="lname" required="" lay-verify="pass"
	    ...
	    <div class="layui-form-item">
	        ...
	        <div class="layui-input-inline">
	            <input type="file" id="L_pass" name="icon" class="layui-input">
	        </div>
