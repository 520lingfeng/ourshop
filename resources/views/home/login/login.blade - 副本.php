    ...
    <div class="w">
        <div class="login-form">
            <div class="login-tab login-tab-r">
                <a style="margin-left:-90px">密码找回</a>
            </div>
                ...
                <div class="form">
                    ...
                    <form action="/doforget" id="formlogin" method="post" >
                        <div class="item item-fore1 item-error">
                            ...
                            <input type="ma" name="email" id="loginname" class="itxt" tabindex="1" autocomplete="off" placeholder="邮箱">
                            @if(session('error0'))
                                {{session('error0')}}
                            @endif
                        ...
                        {{csrf_field()}}
                            <div class="login-btn">
                                <button class="btn-img btn-entry" id="loginsubmit" tabindex="6" on11Click="validate()">密码找回</button>
                            </div>
                        </div>
