...
<section id="member">
    <div class="member-center clearfix">
        ...
        <div class="m_right">
          ...
          <form action="/member/{{$userinfo->id}}" method="post" enctype="multipart/form-data">
            <div class="mem_t">账号信息</div>
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              <tbody>
              <tr><td><img src={{$userinfo->head}} width="90"></td></tr>
              <td width="115"><input type="file" name = "head"></td>
                    <td>
              ...
              <tr>
                ...
                <td width="60%">姓名：<span style="color:#555555;"><input type="text" name = 'name' value={{$userinfo->name}}></span></td>
              </tr>
              <tr>
                <td width="40%">性别：<span style="color:#555555;">
                <input type="radio" name='sex' value="1" @if($userinfo->sex == 1) checked @endif>男
                <input type="radio" name='sex' value="0" @if($userinfo->sex == 0) checked @endif>女
                <input type="radio" name='sex' value="2" @if($userinfo->sex == 2) checked @endif>保密
                </span></td>
                <td width="60%">年龄：<span style="color:#555555;"><input type="text" name = 'age' value={{$userinfo->age}}></span></td>
              </tr>
              <tr>
                <td>电&nbsp; &nbsp; 话：<span style="color:#555555;"><input type="text" name='phone' value={{$userinfo->phone}}> </span></td>
                <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><input type="email" name='email' value={{$userinfo->email}}></span></td>
              </tr>
              <tr>
                <td>地址：<span style="color:#555555;"><input type="text" name = 'address' value={{$userinfo->address}}></span></td>
              ...
              {{ method_field('PUT') }}
              <tr>
                <td><button class="button">确定</button></td>
              </tr>
            </tbody></table>
          </form>     
