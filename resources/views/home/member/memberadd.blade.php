          ...
          <form action="/member" method="post" enctype="multipart/form-data">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="60%">姓名：<span style="color:#555555;"><input type="text" name = 'name'></span></td>
              </tr>
              <tr>
                ...
                <td width="60%">年龄：<span style="color:#555555;"><input type="text" name = 'age'></span></td>
              </tr>
              <tr>
                <td>电&nbsp; &nbsp; 话：<span style="color:#555555;"><input type="text" name='phone'> </span></td>
                <td>邮&nbsp; &nbsp; 箱：<span style="color:#555555;"><input type="email" name='email'></span></td>
              </tr>
              <tr>
                <td>地址：<span style="color:#555555;"><input type="text" name = 'address'></span></td>
